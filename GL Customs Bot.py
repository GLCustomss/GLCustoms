...
async def rewards(ctx):
    ...
    embed = discord.Embed(
        ...
        description=(
            ...
            "**Casino Commands**\n"
            "`!slots`, `!roulette`, `!crash`, `!rocket`, `!dice`, `!baccarat`, `!plinko`, `!mines`, `!mine`, `!bj`, `!blackjack`, `!balance`, `!bal`, `!beg`, `!work`, `!give`, `!rewards`, `!profit`, `!mystats`, `!leaderboard`, `!rank`\n\n"
            "**Mines Jackpot**\n"
...
async def vehiclehelp(ctx):
    ...
    embed = build_case_embed(
        ...
        extra_fields=[
            ...
            ("Date Issued", "19-04-2026 10:46", False)
        ]
    )
    await ctx.send(embed=embed)
...
class AdvancedHelpView(discord.ui.View):
    ...
    def build_vehicle_embed(self):
        ...
        embed.add_field(name="Date Issued", value="19-04-2026 10:46", inline=False)
        return embed
    ...
    @discord.ui.button(label="Vehicle", style=discord.ButtonStyle.secondary, row=1)
